...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    for i in range(1,4):
        str_W = 'W' + str(i)
        str_b = 'b' + str(i)
        self.params[str_W] = np.random.normal(loc = 0.0, scale = weight_scale, size = shapes[str_W])
  ...
  def loss(self, X, y=None):
    ...
    dh2,dw3, grads['b3'] = affine_backward(dz, cache3)
    dh1, dw2, grads['b2'] = affine_relu_backward(dh2, cache2)
    _, dw1, grads['b1'] = conv_relu_pool_backward(dh1, cache1)
