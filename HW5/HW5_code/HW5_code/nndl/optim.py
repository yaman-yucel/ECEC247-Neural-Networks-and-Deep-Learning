...
def rmsprop(w, dw, config=None):
    ...
    next_w = w - config['learning_rate'] * c * dw 
    # ================================================================ #
    # END YOUR CODE HERE
    # ================================================================ #
...
def adam(w, dw, config=None):
    ...
    v_tld = config['v'] / ( 1 - config['beta1'] ** config['t'])
    a_tld = config['a'] / ( 1 - config['beta2'] ** config['t'])
    
    c = 1 / (np.sqrt(a_tld) + config['epsilon'])
    next_w = w - config['learning_rate'] * v_tld * c
